                ...
                <div className="flex flex-col lg:flex-row items-start justify-between gap-8 lg:gap-16">
                    ...
                    <div className="flex-1 pt-16 lg:pt-32">
                        <div className="space-y-6">
                            <p
                                className="font-unbounded text-lg lg:text-2xl font-medium uppercase leading-loose tracking-wide"
                            ...
                            <div className="space-y-4">
                                <h1
                                    className="font-unbounded text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-black uppercase leading-tight"
                                    style={{ color: "var(--accent-50)" }}
                                >
                                    Drive With
                                </h1>
                                <h1
                                    className="font-unbounded text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-black uppercase leading-tight pl-8"
                                    style={{ color: "var(--accent-50)" }}
                                >
                                    Confidence
                                </h1>
