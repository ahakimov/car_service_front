    ...
    const getDayClassName = (day: Date) => {
        ...
        return cn(
            'relative w-10 h-10 rounded-full flex items-center justify-center transition-colors',
            {
                ...
                // Text colors
                'text-[var(--neutral-400)]': isDisabled,
                'text-[var(--neutral-600)]': !isCurrentMonth && !isDisabled,
                'text-[var(--neutral-900)]': isCurrentMonth && !isSelected && !isDisabled,
                'text-white font-medium': isSelected && !isDisabled,

                // Background colors
                'bg-[var(--primary-600)]': isSelected && !isDisabled,
                'bg-[var(--neutral-100)]': isTodayDate && !isSelected && !isDisabled,
                'bg-[var(--primary-50)] text-[var(--primary-700)]': isHovered && !isSelected && !isDisabled,

                // Hover state
                'hover:bg-[var(--primary-50)] hover:text-[var(--primary-700)]': !isSelected && !isDisabled,
            }
        );
    };
